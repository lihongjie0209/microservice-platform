...
application-manifest-invariants-check:
	go test scripts/check_application_manifests.go scripts/check_application_manifests_test.go
	go run scripts/check_application_manifests.go
