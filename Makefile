...
YQ_VERSION ?= v4.50.1
SERVICES := identity-service tenant-service authorization-service audit-service config-service notification-service file-service scheduler-service swagger-service application-service dictionary-service service-registry-service webhook-service workflow-service search-service
SERVICE ?=
