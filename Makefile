...
verify: contracts-check sdk-test services-test services-vet services-swagger-check delivery-check compose-check console-endpoint-invariants-check loop-failure-check integration-policy-check event-bus-check event-reliability-check contract-ownership-check api-invariants-check authorization-invariants-check menu-permission-invariants-check database-invariants-check
...
event-reliability-check:
	sh scripts/test-event-reliability.sh

contract-ownership-check:
	sh scripts/test-contract-ownership.sh

api-invariants-check:
	sh scripts/test-api-invariants.sh

authorization-invariants-check:
	go test scripts/check_authz_invariants.go scripts/check_authz_invariants_test.go
	go run scripts/check_authz_invariants.go

menu-permission-invariants-check:
	go test scripts/check_menu_permission_invariants.go scripts/check_menu_permission_invariants_test.go
	go run scripts/check_menu_permission_invariants.go

console-endpoint-invariants-check:
	go test scripts/check_console_endpoints.go scripts/check_console_endpoints_test.go
	go run scripts/check_console_endpoints.go
