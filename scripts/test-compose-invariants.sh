...
for consumer_name in audit-service billing-service dictionary-service scheduler-service search-service workflow-service data-export-service metering-service; do
