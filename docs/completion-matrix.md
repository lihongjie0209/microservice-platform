...
| data-export | 应用级异步任务创建、查询、分页、取消、重试、下载 | 中央 Export API；携带租户/应用的通用流式 Export Provider 协议 | 携带应用作用域的请求及成功/失败/取消/重试/过期事件 + Outbox | 应用授权、作用域幂等、数据库原子 claim、分层对象键、流式 S3/MinIO、到期清理、乐观锁 |
